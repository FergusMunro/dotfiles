...
-- Set a custom keybinding to toggle NvimTree
vim.keymap.set('n', '<C-n>', ':NvimTreeToggle<CR>', { noremap = true, silent = true })

-- setup shite for bufferline
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      local servers = {
        clangd = {},
        -- gopls = {},quickshell /usr/lib/qt6/qml/Quickshell/Services/SystemTray/quickshell-service-statusnotifier.qmltypes
        pyright = {},
        hls = {},
        qmlls = {
          cmd = {
          ...
          root_dir = require('lspconfig.util').root_pattern('.qmlls.ini', '.git', 'qmldir'),
        },
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { hs = true }
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  - yiq - [Y]ank [I]nside [N]ext [Q]uote
